...
function M.load(c)
  ...
  hi("BufferLineBackground",          { fg = c.comment,  bg = c.cursorline })
  hi("BufferLineSelected",            { fg = c.fg,       bg = c.bg,      bold = true })
  hi("BufferLineIndicatorSelected",   { fg = c.keyword,  bg = c.bg })
  hi("BufferLineSeparator",           { fg = c.ui_mid,   bg = c.cursorline })
  hi("BufferLineSeparatorSelected",   { fg = c.ui_mid,   bg = c.bg })
  hi("BufferLineModified",            { fg = c.warning,  bg = c.cursorline })
  hi("BufferLineModifiedSelected",    { fg = c.warning,  bg = c.bg })
  hi("BufferLineCloseButton",         { fg = c.comment,  bg = c.cursorline })
